...
# Load dataset
expense_data_path = 'Machine Learning Datasets/Expense Forecasting for Individual Users/Expense_Forecasting_Synthetic_Data.csv'
...
# Split data into training (UserID 1-90) and testing (UserID 91-100)
train_data = pivot_df[pivot_df['UserID'] <= 90]
test_data = pivot_df[pivot_df['UserID'] > 90]
...
joblib.dump(scaler, 'finance_management_backend/ml_app/expense_scaler.pkl')
...
model.save('finance_management_backend/ml_app/expense_forecasting_model.h5')
