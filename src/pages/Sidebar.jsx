...
export function SidebarPage() {
  ...
  // Handle app selection change and navigate to default route
  const handleAppChange = (app) => {
    setSelectedApp(app);
    const defaultRoute = app === "BudgetWise" ? "/dashboard" : "/swdashboard";
        ...
        <SidebarBody className="justify-between gap-10">
          <div className="flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
            <div className="flex items-center gap-2 py-2">
              <LogoIcon />
              <select
                className="text-white bg-black border border-white rounded-md px-2 py-1 outline-none appearance-none"
                value={selectedApp}
